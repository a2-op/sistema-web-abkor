					...
					v-toolbar(flat color="white")
						...
						v-dialog(v-model="dVisit.status" persistent max-width="1000px")
							v-card
								...
								v-card-actions
									v-spacer
									v-btn(text @click="toggleDialog('dVisit', false, () => {})" color="primary") Cancelar
									v-btn(text @click="toggleDialog('dVisit', false, saveVisit)" :loading="dVisit.loading" :disabled="dVisit.loading") Guardar
