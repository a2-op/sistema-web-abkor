											...
											v-row
												v-col(cols="12" xs="12" sm="6" md="8" lg="8")
													v-row
														...
														v-col(cols="12" xs="12" sm="12" md="12" lg="12")
															span Descripción
															v-textarea.mt-5(v-model="editedNotice.description")
													...
													v-row
														...
														v-col(cols="12" xs="12" sm="12" md="12" lg="12")
															v-dialog(ref="dialog" v-model="modal" :return-value.sync="date" persistent width="290px")
																template(v-slot:activator="{ on }")
																	v-text-field(v-model="editedNotice.end" label="Expiración del anuncio" readonly v-on="on" required)
																v-date-picker(v-model="editedNotice.end" scrollable)
																	v-spacer
